...
import renderReactSelect from '../components/composite/core/ReactSelect';
import renderTextFieldCheckBoxCombination from '../components/composite/section1Rendered/TextFieldCheckBox';
import renderDatePickerCheckBoxCombination from '../components/composite/section1Rendered/DatePickerCheckBox';
import renderDatePickerSimple from '../components/composite/section1Rendered/DatePickerSimple';
import renderAddressFieldCombination from '../components/composite/section1Rendered/Address';
...
class Section1ContentRendered extends Component {
    constructor(props) {
        super(props);
        this.state = {
            birthDate: '',
    ...
    componentDidMount() {
        this.props.fetchData(this.props.orderId);
    }
    ...
    submitOrder(event){
        var values = this.props.formValues.Section1ContentRendered.values;
        values.formI9.section1.dob =  this.format(values.formI9.section1.dob);
        if (values.formI9.section1.expirationDate) {
            values.formI9.section1.expirationDate = this.format(values.formI9.section1.expirationDate);
        }
        this.props.saveData(this.props.formValues.Section1ContentRendered.values);
    }

    render() {
        const { handleSubmit, eligibilityType, empAuthDoc} = this.props;
        const i9sec1 = this.props.formValues.Section1ContentRendered;
        return (
            <form onSubmit = {handleSubmit}>
                <Divider className="break"/>

                <b>This is the Form I-9 for Anvita Bajpai</b>
                ...
                <div className="outerDiv nonBreakingSpace">
                    <Field name="middleInitial"
                           ...
                           initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.middleInitial : ''}
                           initialDataNA={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.middleInitialNA : ''}
                ...
                <div className="doubleBreak">
                    <Field name="otherLastNames"
                           ...
                           initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.otherFamilyNames : ''}
                           initialDataNA={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.otherFamilyNamesNA : ''}
                           component={renderTextFieldCheckBoxCombination}
                ...
                <div className="break">
                    <Field name="ssn"
                           ...
                           component={renderTextFieldCheckBoxCombination}
                           initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.ssn : ''}
                           initialDataNA={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.awaitingSSN : ''}
                ...
                <div className="doubleBreak">
                    <Field name="dob"
                           nameTag="formI9.section1.dob"
                           component={renderDatePickerSimple}
                           initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.dob : ''}
                ...
                <div className="doubleBreak">
                    <Field name="address"
                           ...
                           unitInitialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.address.line2 : ''}
                           unitInitialDataNA={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.address.line2NA : ''}
                           stateInitialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.address.regionCode : ''}
                           countryInitialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.address.countryCode : ''}
                           width={260}
                ...
                <div>
                    <Field name="email"
                           ...
                           component={renderTextFieldCheckBoxCombination}
                           initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.email : ''}
                           initialDataNA={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.emailNA : ''}
                           label="Email *"
                ...
                <div className="doubleBreak">
                    <Field name="phone"
                           ...
                           component={renderTextFieldCheckBoxCombination}
                           initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.phone : ''}
                           initialDataNA={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.phoneNA : ''}
                ...
                {eligibilityType === AAW && <div>
                    <div className="break negativeMarginTop">
                        <Field name="workAuthExpDate"
                               ...
                               initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.expirationDate : ''}
                               initialDataNA={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.expirationDateNA : ''}
                ...
                {empAuthDoc === FOREIGN_PP  && !(eligibilityType === CITIZEN || eligibilityType === NON_CITIZEN || eligibilityType === LPR) && <div>
                    ...
                    <Field name="formI9.section1.issuingCountry"
                           ...
                           ref="issuingCountry"
                           component={renderReactSelect}
                           initialData={(i9sec1 && i9sec1.values)? i9sec1.values.formI9.section1.issuingCountry : ''}
...
const selector = formValueSelector('Section1ContentRendered') // <-- same as form name
...
export default connect(mapStateToProps, mapDispatchToProps)(Section1ContentRendered);
