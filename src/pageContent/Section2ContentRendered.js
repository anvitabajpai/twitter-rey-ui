...
class Section2ContentRendered extends Component {
    constructor(props) {
        super(props);
        this.state = {
            hireDate: '',
...
Section2ContentRendered = reduxForm({
    form: 'Section2ContentRendered', // a unique identifier for this form
    validate,
})(Section2ContentRendered);

// Decorated with connect to read form values
const selector = formValueSelector('Section2ContentRendered') // <-- same as form name
Section2ContentRendered = connect(
    state => {
...
export default Section2ContentRendered